    ...
    module Analysis
      def extract_entities(text)
        ...
        
        {
          ...
          dates: text.scan(/\b(?:\d{1,2}[-\/]\d{1,2}[-\/]\d{2,4}|(?:(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)[a-z]*|(?:January|February|March|April|May|June|July|August|September|October|November|December)) \d{1,2},? \d{4}|\d{4}[-\/]\d{1,2}[-\/]\d{1,2})\b/i).uniq,
